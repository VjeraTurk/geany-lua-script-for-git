...
--SAVE_FILE = "/usr/share/geany-plugins/geanylua/edit/proba.lua"
SAVE_FILE = "/home/vjera/Desktop/test2.lua"
--SAVE_PATH = "/home/vjera/Desktop/"
...
onSaveExts = {
	[".js"] = function(file)
		...
		local cmd = "js-beautify FILE " .. geany.filename() .. " -o " .. SAVE_FILE 
		
		--local cmd = "js_beautify FILE" ..SAVE_PATH, geany.filename() .. " >> " .. SAVE_FILE -- - u _ i maknut -f
		local cmd0="cd "..SAVE_PATH.." "
	--	local cmd = "js_beautify FILE" ..SAVE_PATH, geany.filename() .. " >> " .. SAVE_FILE -- - u _ i maknut -f
	--	local cmd = "js_beautify FILE" ..geany.filename() .. " >> " .. SAVE_FILE -- - u _ i maknut -f
		
		--os.execute(cmd0)
		os.execute(cmd)
		geany.status("formatting js file: " .. geany.filename()) 
		--geany.message("formatting js file: " .. geany.filename()) 
...
local file = assert(io.open(SAVE_FILE, "r")) --r???
